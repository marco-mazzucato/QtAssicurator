...
RCA::RCA(std::string n, std::string c, std::string codf, unsigned int e, int codp, QDate d, double cb, unsigned int cil, unsigned int cav, bool neo): AssBeni(n, c, codf, e, codp, d, cb), cilindrata(cil), cavalli(cav), neopatentato(neo) {}
