...
AssBeni::AssBeni(std::string n, std::string c, std::string codf, unsigned int e, std::string codp, QDate d, double cb): Assicurazione(n, c, codf, e, codp, d), costoBene(cb){}
