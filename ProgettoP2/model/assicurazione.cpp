...
Assicurazione::Assicurazione(std::string n, std::string c, std::string codf, unsigned int e, int codp, QDate d): nome(n), cognome(c), codFiscale(codf), eta(e), codPolizza(codp), inizioContratto(d){}
...
const int& Assicurazione::getCodPolizza() const {return codPolizza;}
